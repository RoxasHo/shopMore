                                ...
                                <ul>
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{ route('view_report_form')}}">View Report</a></li>                                     
                                        </ul>
                                        @endif
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>1 Jalan Satu
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>0123456789
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>shopmore@shopmore.com
                            </p>
                    ...
                    <div class="col-lg-3 col-md-3">
                        ...
                        <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
                            ...
                            <li><a href="{{route('pnp')}}">Privacy Policy</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="float-md-left font-sm text-muted mb-0">
                        <a href="{{route('pnp')}}">Privacy Policy</a> | <a href="{{route('tnc')}}">Terms & Conditions</a>
                    </p>
                </div>
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Shop More</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
